...
def import_core_modules() -> Tuple[Any, Any, Any, str]:
    """
    Tenta importar módulos do projeto em duas variações:
    - core (recomendado)
    - Core (caso o repositório esteja com pasta maiúscula)
    Retorna: (state_mod, tibia_mod, utilities_mod, prefix)
    """
    ...
    for prefix in ("core", "Core"):
        try:
            ...
            util_mod = importlib.import_module(f"{prefix}.utilities")
            return state_mod, tibia_mod, util_mod, prefix
